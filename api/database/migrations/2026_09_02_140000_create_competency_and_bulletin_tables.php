...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        TenantSchema::ensureCompositePrimary('subjects');

        if (! Schema::hasTable('competency_domains')) {
        ...
        TenantSchema::ensureCompositePrimary('competency_domains');

        if (! Schema::hasTable('competency_items')) {
        ...
        TenantSchema::ensureCompositePrimary('competency_items');
        ...
        if (! Schema::hasTable('bulletin_comments')) {
            ...
            DB::statement('ALTER TABLE bulletin_comments ADD CONSTRAINT bulletin_comments_subject_fk FOREIGN KEY (school_id, subject_id) REFERENCES subjects (school_id, id) MATCH SIMPLE');
